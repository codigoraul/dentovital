...
$SITE_URL = (isset($_SERVER['HTTP_HOST']) && is_string($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST'] !== '')
  ...
  : 'https://dentistaantofagasta.cl';

$TO_EMAILS_BASE = 'clinicaodontologicadentovital@gmail.com';
$TO_EMAIL = $TO_EMAILS_BASE;
$FROM_EMAIL = 'contacto@dentistaantofagasta.cl';
$FROM_NAME = 'Clínica Dentovital';
$BCC_EMAILS = '';
...
$subject = 'Nueva consulta desde Clínica Dentovital';
if ($asunto !== '') {
...
$bodyHtml = '<!doctype html><html><head><meta charset="UTF-8"></head><body style="font-family:Arial,Helvetica,sans-serif; color:#111827;">'
  . '<h2 style="margin:0 0 16px; font-size:18px;">Nueva consulta desde Clínica Dentovital</h2>'
...
$bodyText = "Nueva consulta desde Clínica Dentovital\n\n"
  . "Nombre: {$nombre}\n"
  . "Email: {$email}\n"
...
$boundary = 'dentovital_' . bin2hex(random_bytes(12));
$body = "--{$boundary}\r\n"
